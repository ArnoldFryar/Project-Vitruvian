...
# direct methods
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap$Config;LP4/g;LP4/f;Z)Landroid/graphics/Bitmap;
    .locals 5
    ...
    :cond_3
    iget-object v3, p2, LP4/g;->a:LP4/a;

    invoke-static {v3, p3}, LT4/e;->f(LP4/a;LP4/f;)I
    ...
    :cond_4
    iget-object v2, p2, LP4/g;->b:LP4/a;

    invoke-static {v2, p3}, LT4/e;->f(LP4/a;LP4/f;)I

    move-result v2

    :goto_3
    invoke-static {p4, v1, v3, v2, p3}, LG4/f;->m(IIIILP4/f;)D
    ...
    :cond_c
    iget-object v0, p2, LP4/g;->a:LP4/a;

    invoke-static {v0, p3}, LT4/e;->f(LP4/a;LP4/f;)I
    ...
    :cond_d
    iget-object p2, p2, LP4/g;->b:LP4/a;

    invoke-static {p2, p3}, LT4/e;->f(LP4/a;LP4/f;)I

    move-result p2

    :goto_a
    invoke-static {v1, v2, v0, p2, p3}, LG4/f;->m(IIIILP4/f;)D
    ...
    invoke-static {p2, p3}, LD3/b;->c(D)I

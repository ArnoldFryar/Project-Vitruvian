...
.method static constructor <clinit>()V
    ...
    sput-object v0, LI5/d;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    sput-object v0, LI5/d;->c:Ljava/util/LinkedHashSet;

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    sput-object v0, LI5/d;->d:Ljava/util/LinkedHashSet;
...
.method public static final d(Landroid/app/Activity;)V
    ...
    :try_start_1
    sget-object v1, LI5/d;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_3
    sget-object v1, LI5/d;->c:Ljava/util/LinkedHashSet;
    ...
    sget-object v1, LI5/d;->d:Ljava/util/LinkedHashSet;
    ...
    invoke-static {p0}, LI5/e$a;->a(Landroid/app/Activity;)V
    ...
    invoke-static {p0}, LI5/e$a;->b(Landroid/app/Activity;)V
    :try_end_3
...
.method public final b()V
    ...
    :cond_1
    iget-object v0, v0, LK5/q;->l:Ljava/lang/String;
    ...
    sget-object v0, LI5/d;->c:Ljava/util/LinkedHashSet;
    ...
    sget-object v0, LI5/d;->d:Ljava/util/LinkedHashSet;
    ...
    :cond_3
    :goto_0
    invoke-static {}, LF5/f;->d()Ljava/io/File;
    ...
    :cond_4
    invoke-static {v0}, LI5/a;->d(Ljava/io/File;)V

    sget-object v0, LE5/e;->m:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v0}, LI5/d;->d(Landroid/app/Activity;)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    sget-object v6, LI5/d;->c:Ljava/util/LinkedHashSet;

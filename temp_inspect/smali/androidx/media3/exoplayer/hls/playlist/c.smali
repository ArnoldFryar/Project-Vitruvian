...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Landroidx/media3/common/i;Ljava/util/List;ZLjava/util/Map;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p10}, LV2/c;-><init>(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    check-cast p10, Landroidx/media3/exoplayer/hls/playlist/c$b;

    iget-object p10, p10, Landroidx/media3/exoplayer/hls/playlist/c$b;->a:Landroid/net/Uri;
    ...
    :cond_1
    invoke-static {p4, p1}, Landroidx/media3/exoplayer/hls/playlist/c;->b(Ljava/util/List;Ljava/util/ArrayList;)V

    invoke-static {p5, p1}, Landroidx/media3/exoplayer/hls/playlist/c;->b(Ljava/util/List;Ljava/util/ArrayList;)V

    invoke-static {p6, p1}, Landroidx/media3/exoplayer/hls/playlist/c;->b(Ljava/util/List;Ljava/util/ArrayList;)V

    invoke-static {p7, p1}, Landroidx/media3/exoplayer/hls/playlist/c;->b(Ljava/util/List;Ljava/util/ArrayList;)V
    ...
    iput-object p8, p0, Landroidx/media3/exoplayer/hls/playlist/c;->j:Landroidx/media3/common/i;
...
.method public static c(ILjava/util/List;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget v6, v5, LH2/w;->b:I

    if-ne v6, p0, :cond_0

    iget v5, v5, LH2/w;->c:I
...
.method public final a(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {v1, v0, p1}, Landroidx/media3/exoplayer/hls/playlist/c;->c(ILjava/util/List;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v2, p0, LV2/c;->b:Ljava/util/List;

    iget-object v8, p0, Landroidx/media3/exoplayer/hls/playlist/c;->j:Landroidx/media3/common/i;

    iget-object v9, p0, Landroidx/media3/exoplayer/hls/playlist/c;->k:Ljava/util/List;

    iget-boolean v10, p0, LV2/c;->c:Z

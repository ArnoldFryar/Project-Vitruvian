...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/media3/datasource/RawResourceDataSource;->e:Landroid/content/res/Resources;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Landroidx/media3/datasource/RawResourceDataSource;->f:Ljava/lang/String;
...
.method public final b(LN2/e;)J
    ...
    iget-object v2, v0, LN2/e;->a:Landroid/net/Uri;

    invoke-virtual {v2}, Landroid/net/Uri;->normalizeScheme()Landroid/net/Uri;

    move-result-object v2

    iput-object v2, v1, Landroidx/media3/datasource/RawResourceDataSource;->g:Landroid/net/Uri;
    ...
    iget-object v6, v1, Landroidx/media3/datasource/RawResourceDataSource;->e:Landroid/content/res/Resources;
    ...
    invoke-static {v4, v10}, LC/t;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    :goto_0
    invoke-static {v9, v4, v3}, LO2/l;->i(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "raw"

    iget-object v9, v1, Landroidx/media3/datasource/RawResourceDataSource;->f:Ljava/lang/String;
    ...
    iput-object v3, v1, Landroidx/media3/datasource/RawResourceDataSource;->h:Landroid/content/res/AssetFileDescriptor;
    ...
    iput-object v2, v1, Landroidx/media3/datasource/RawResourceDataSource;->i:Ljava/io/FileInputStream;
    ...
    iput-wide v9, v1, Landroidx/media3/datasource/RawResourceDataSource;->j:J
    ...
    iput-wide v4, v1, Landroidx/media3/datasource/RawResourceDataSource;->j:J
    ...
    iput-wide v5, v1, Landroidx/media3/datasource/RawResourceDataSource;->j:J
    :try_end_2
    ...
    :goto_4
    iget-wide v2, v0, LN2/e;->g:J

    cmp-long v4, v2, v9

    if-eqz v4, :cond_c

    iget-wide v5, v1, Landroidx/media3/datasource/RawResourceDataSource;->j:J
    ...
    :cond_c
    iput-boolean v7, v1, Landroidx/media3/datasource/RawResourceDataSource;->k:Z
    ...
    :cond_d
    iget-wide v2, v1, Landroidx/media3/datasource/RawResourceDataSource;->j:J
...
.method public final close()V
    ...
    iput-object v0, p0, Landroidx/media3/datasource/RawResourceDataSource;->g:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/media3/datasource/RawResourceDataSource;->i:Ljava/io/FileInputStream;
    ...
    :cond_0
    :goto_0
    iput-object v0, p0, Landroidx/media3/datasource/RawResourceDataSource;->i:Ljava/io/FileInputStream;
...
.method public final o()Landroid/net/Uri;
    ...
    iget-object v0, p0, Landroidx/media3/datasource/RawResourceDataSource;->g:Landroid/net/Uri;
...
.method public final read([BII)I
    ...
    :goto_0
    iget-object v0, p0, Landroidx/media3/datasource/RawResourceDataSource;->i:Ljava/io/FileInputStream;

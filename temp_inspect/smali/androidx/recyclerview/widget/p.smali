...
.field public static final C:Landroidx/recyclerview/widget/p$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/p;->B:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/p$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/p;->C:Landroidx/recyclerview/widget/p$a;
...
.method public static c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$z;
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroidx/recyclerview/widget/RecyclerView$r;->k(IJ)Landroidx/recyclerview/widget/RecyclerView$z;
...
.method public final a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_0
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->C0:Landroidx/recyclerview/widget/p$b;
...
.method public final b(J)V
    ...
    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->C0:Landroidx/recyclerview/widget/p$b;
    ...
    :cond_1
    iget-object v4, v1, Landroidx/recyclerview/widget/p;->A:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v9, v8, Landroidx/recyclerview/widget/RecyclerView;->C0:Landroidx/recyclerview/widget/p$b;
    ...
    :cond_6
    sget-object v0, Landroidx/recyclerview/widget/p;->C:Landroidx/recyclerview/widget/p$a;
    ...
    invoke-static {v5, v6, v8, v9}, Landroidx/recyclerview/widget/p;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$z;

    move-result-object v5

    if-eqz v5, :cond_e

    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView$z;->b:Ljava/lang/ref/WeakReference;

    if-eqz v6, :cond_e

    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$z;->h()Z

    move-result v6

    if-eqz v6, :cond_e

    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$z;->i()Z

    move-result v6

    if-nez v6, :cond_e

    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView$z;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->C:Landroidx/recyclerview/widget/c;
    ...
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->l0:Landroidx/recyclerview/widget/l;

    if-eqz v6, :cond_a

    invoke-virtual {v6}, Landroidx/recyclerview/widget/l;->h()V

    :cond_a
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->K:Landroidx/recyclerview/widget/RecyclerView$l;

    iget-object v8, v5, Landroidx/recyclerview/widget/RecyclerView;->c:Landroidx/recyclerview/widget/RecyclerView$r;

    if-eqz v6, :cond_b

    invoke-virtual {v6, v8}, Landroidx/recyclerview/widget/RecyclerView$l;->c0(Landroidx/recyclerview/widget/RecyclerView$r;)V

    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->K:Landroidx/recyclerview/widget/RecyclerView$l;

    invoke-virtual {v6, v8}, Landroidx/recyclerview/widget/RecyclerView$l;->d0(Landroidx/recyclerview/widget/RecyclerView$r;)V

    :cond_b
    iget-object v6, v8, Landroidx/recyclerview/widget/RecyclerView$r;->a:Ljava/util/ArrayList;
    ...
    :cond_c
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->C0:Landroidx/recyclerview/widget/p$b;
    ...
    iget-object v8, v5, Landroidx/recyclerview/widget/RecyclerView;->D0:Landroidx/recyclerview/widget/RecyclerView$w;

    iget-object v9, v5, Landroidx/recyclerview/widget/RecyclerView;->J:Landroidx/recyclerview/widget/RecyclerView$e;

    iput v7, v8, Landroidx/recyclerview/widget/RecyclerView$w;->d:I
    ...
    iput-boolean v3, v8, Landroidx/recyclerview/widget/RecyclerView$w;->g:Z

    iput-boolean v3, v8, Landroidx/recyclerview/widget/RecyclerView$w;->h:Z

    iput-boolean v3, v8, Landroidx/recyclerview/widget/RecyclerView$w;->i:Z
    ...
    invoke-static {v5, v9, v10, v11}, Landroidx/recyclerview/widget/p;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$z;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

...
.method public final a(Landroidx/recyclerview/widget/a$b;)V
    ...
    :cond_0
    iget-object v0, v2, Landroidx/recyclerview/widget/RecyclerView;->K:Landroidx/recyclerview/widget/RecyclerView$l;

    iget v1, p1, Landroidx/recyclerview/widget/a$b;->b:I

    iget p1, p1, Landroidx/recyclerview/widget/a$b;->d:I

    invoke-virtual {v0, v1, p1}, Landroidx/recyclerview/widget/RecyclerView$l;->U(II)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/recyclerview/widget/RecyclerView$l;->W(II)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/recyclerview/widget/RecyclerView$l;->V(II)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/recyclerview/widget/RecyclerView$l;->S(II)V

    :goto_0
    return-void
.end method

.method public final b(I)Landroidx/recyclerview/widget/RecyclerView$z;
    .locals 7
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView;->C:Landroidx/recyclerview/widget/c;
    ...
    :cond_0
    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView;->C:Landroidx/recyclerview/widget/c;

    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView$z;->a:Landroid/view/View;

    invoke-virtual {v4, v6}, Landroidx/recyclerview/widget/c;->j(Landroid/view/View;)Z
    ...
    :cond_4
    iget-object p1, v0, Landroidx/recyclerview/widget/RecyclerView;->C:Landroidx/recyclerview/widget/c;

    iget-object v0, v4, Landroidx/recyclerview/widget/RecyclerView$z;->a:Landroid/view/View;

    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/c;->j(Landroid/view/View;)Z
...
.method public final c(IILjava/lang/Object;)V
    ...
    invoke-virtual {p3, v2}, Landroidx/recyclerview/widget/RecyclerView$r;->g(I)V
...
.method public final d(II)V
    ...
    invoke-virtual {v5, p2, v2}, Landroidx/recyclerview/widget/RecyclerView$z;->o(IZ)V

    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView;->D0:Landroidx/recyclerview/widget/RecyclerView$w;
    ...
    invoke-virtual {v6, p2, v2}, Landroidx/recyclerview/widget/RecyclerView$z;->o(IZ)V
...
.method public final e(II)V
    ...
    iget-object v9, v0, Landroidx/recyclerview/widget/RecyclerView;->C:Landroidx/recyclerview/widget/c;
    ...
    invoke-virtual {v9, v10, v7}, Landroidx/recyclerview/widget/RecyclerView$z;->o(IZ)V

    goto :goto_2

    :cond_2
    invoke-virtual {v9, v6, v7}, Landroidx/recyclerview/widget/RecyclerView$z;->o(IZ)V

    :goto_2
    iget-object v9, v0, Landroidx/recyclerview/widget/RecyclerView;->D0:Landroidx/recyclerview/widget/RecyclerView$w;

    iput-boolean v2, v9, Landroidx/recyclerview/widget/RecyclerView$w;->f:Z
    ...
    :cond_7
    invoke-virtual {v9, v3, v7}, Landroidx/recyclerview/widget/RecyclerView$z;->o(IZ)V

...
.method public final a(Landroidx/media3/common/audio/AudioProcessor$a;)Landroidx/media3/common/audio/AudioProcessor$a;
    ...
    iput-boolean v0, p0, LS2/q;->k:Z

    iget v0, p0, LS2/q;->i:I

    if-nez v0, :cond_1

    iget v0, p0, LS2/q;->j:I
...
.method public final c()V
    ...
    iget-boolean v0, p0, LS2/q;->k:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iput-boolean v1, p0, LS2/q;->k:Z
    ...
    iput-object v0, p0, LS2/q;->m:[B

    iget v0, p0, LS2/q;->i:I

    mul-int/2addr v0, v2

    iput v0, p0, LS2/q;->l:I

    :cond_0
    iput v1, p0, LS2/q;->n:I
...
.method public final e()Ljava/nio/ByteBuffer;
    ...
    iget-object v1, p0, LS2/q;->m:[B

    iget v2, p0, LS2/q;->n:I
...
.method public final f(Ljava/nio/ByteBuffer;)V
    ...
    :cond_0
    iget v3, p0, LS2/q;->l:I

    invoke-static {v2, v3}, Ljava/lang/Math;->min(II)I

    move-result v3

    iget-wide v4, p0, LS2/q;->o:J
    ...
    iput-wide v4, p0, LS2/q;->o:J

    iget v4, p0, LS2/q;->l:I

    sub-int/2addr v4, v3

    iput v4, p0, LS2/q;->l:I

    add-int/2addr v0, v3

    invoke-virtual {p1, v0}, Ljava/nio/ByteBuffer;->position(I)Ljava/nio/Buffer;

    iget v0, p0, LS2/q;->l:I
    ...
    iget v4, p0, LS2/q;->n:I

    const/4 v5, 0x0

    invoke-static {v0, v5, v4}, LK2/D;->j(III)I

    move-result v4

    iget-object v6, p0, LS2/q;->m:[B

    invoke-virtual {v3, v6, v5, v4}, Ljava/nio/ByteBuffer;->put([BII)Ljava/nio/ByteBuffer;

    sub-int/2addr v0, v4

    invoke-static {v0, v5, v2}, LK2/D;->j(III)I
    ...
    iput v0, p0, LS2/q;->n:I

    iget-object v1, p0, LS2/q;->m:[B

    invoke-static {v1, v4, v1, v5, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p0, LS2/q;->m:[B

    iget v1, p0, LS2/q;->n:I

    invoke-virtual {p1, v0, v1, v2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget p1, p0, LS2/q;->n:I

    add-int/2addr p1, v2

    iput p1, p0, LS2/q;->n:I

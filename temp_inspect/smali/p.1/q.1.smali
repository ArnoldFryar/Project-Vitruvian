...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Lp/q;->a:Landroid/widget/ProgressBar;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lp/q;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v2, Lp/q;->c:[I

    const/4 v3, 0x0

    invoke-static {v1, p1, v2, p2, v3}, Lp/V;->e(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lp/V;

    move-result-object p1

    invoke-virtual {p1, v3}, Lp/V;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v1}, Lp/q;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lp/V;->c(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    if-eqz p2, :cond_3

    invoke-virtual {p0, p2, v3}, Lp/q;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1, p2}, Lp/q;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-interface {v0, p2}, LR1/c;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Lp/q;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lp/q;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v1, p0, Lp/q;->b:Landroid/graphics/Bitmap;

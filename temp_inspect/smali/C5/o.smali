...
.method public static final d(Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/concurrent/ConcurrentHashMap;ZLjava/lang/String;LC5/r$a;Z)V
    .locals 2
    ...
    invoke-virtual {v1, p0, p2}, LC5/o;->a(Ljava/util/concurrent/ConcurrentHashMap;Z)Ljava/util/HashMap;

    move-result-object p0

    invoke-virtual {v1, p3, p0, p1}, LC5/o;->b(Ljava/lang/String;Ljava/util/HashMap;Ljava/util/concurrent/ConcurrentHashMap;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p3, p1, p2, p4, p5}, LE5/j;->d(Ljava/lang/String;Ljava/lang/String;ZLC5/r$a;Z)V
    :try_end_1
...
.method public static final e()V
    ...
    invoke-interface {v9, v0, v10}, Landroid/content/SharedPreferences;->getStringSet(Ljava/lang/String;Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {v5, v10, v11, v11}, LSn/s;->P(Ljava/lang/CharSequence;[Ljava/lang/String;II)Ljava/util/List;
...
.method public final a(Ljava/util/concurrent/ConcurrentHashMap;Z)Ljava/util/HashMap;
    ...
    :goto_0
    invoke-static/range {p1 .. p1}, Llm/I;->W(Ljava/util/Map;)Ljava/util/Map;
...
.method public final b(Ljava/lang/String;Ljava/util/HashMap;Ljava/util/concurrent/ConcurrentHashMap;)Ljava/util/LinkedHashMap;
    .locals 6

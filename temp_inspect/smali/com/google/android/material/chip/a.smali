...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, LL7/f;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    const/high16 p2, -0x40800000    # -1.0f

    iput p2, p0, Lcom/google/android/material/chip/a;->X:F
    ...
    invoke-virtual {p0, p1}, LL7/f;->j(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/google/android/material/chip/a;->y0:Landroid/content/Context;

    new-instance p2, LF7/g;

    invoke-direct {p2, p0}, LF7/g;-><init>(LF7/g$b;)V

    iput-object p2, p0, Lcom/google/android/material/chip/a;->E0:LF7/g;

    const-string v1, ""

    iput-object v1, p0, Lcom/google/android/material/chip/a;->b0:Ljava/lang/CharSequence;

    iget-object p2, p2, LF7/g;->a:Landroid/text/TextPaint;
    ...
    invoke-virtual {p0}, Lcom/google/android/material/chip/a;->E()Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/google/android/material/chip/a;->x([I[I)Z
...
.method public final A(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/material/chip/a;->p(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1}, Lcom/google/android/material/chip/a;->F(Landroid/graphics/drawable/Drawable;)V

    :goto_0
    invoke-virtual {p0}, LL7/f;->invalidateSelf()V

    invoke-virtual {p0}, Lcom/google/android/material/chip/a;->w()V

    :cond_1
    return-void
.end method

.method public final B(LI7/d;)V
    .locals 5

    iget-object v0, p0, Lcom/google/android/material/chip/a;->E0:LF7/g;

    iget-object v1, v0, LF7/g;->f:LI7/d;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, LF7/g;->f:LI7/d;

    iget-object v1, v0, LF7/g;->a:Landroid/text/TextPaint;

    iget-object v2, p0, Lcom/google/android/material/chip/a;->y0:Landroid/content/Context;

    iget-object v3, v0, LF7/g;->b:LF7/g$a;

    invoke-virtual {p1, v2, v1, v3}, LI7/d;->f(Landroid/content/Context;Landroid/text/TextPaint;Lbf/a;)V

    iget-object v4, v0, LF7/g;->e:Ljava/lang/ref/WeakReference;

    invoke-virtual {v4}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v4

    check-cast v4, LF7/g$b;

    if-eqz v4, :cond_0

    invoke-interface {v4}, LF7/g$b;->getState()[I
    ...
    :cond_0
    invoke-virtual {p1, v2, v1, v3}, LI7/d;->e(Landroid/content/Context;Landroid/text/TextPaint;Lbf/a;)V
    ...
    invoke-interface {p1}, LF7/g$b;->getState()[I

    move-result-object v0

    invoke-interface {p1, v0}, LF7/g$b;->onStateChange([I)Z
...
.method public final D()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/chip/a;->d0:Landroid/graphics/drawable/Drawable;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v10, v6, Lcom/google/android/material/chip/a;->B0:Landroid/graphics/RectF;

    if-nez v0, :cond_2

    iget v0, v6, Lcom/google/android/material/chip/a;->F0:I
    ...
    iget-object v0, v6, Lcom/google/android/material/chip/a;->O0:Landroid/graphics/ColorFilter;
    ...
    :cond_3
    iget-object v0, v6, Lcom/google/android/material/chip/a;->P0:Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-super/range {p0 .. p1}, LL7/f;->draw(Landroid/graphics/Canvas;)V

    :cond_5
    iget v0, v6, Lcom/google/android/material/chip/a;->Z:F
    ...
    iget v0, v6, Lcom/google/android/material/chip/a;->X:F
    ...
    :cond_8
    iget v0, v6, Lcom/google/android/material/chip/a;->J0:I
    ...
    iget-object v4, v1, LL7/f$b;->a:LL7/i;

    iget v1, v1, LL7/f$b;->j:F

    iget-object v5, v6, LL7/f;->N:LL7/f$a;

    iget-object v8, v6, LL7/f;->O:LL7/j;
    ...
    invoke-virtual/range {v17 .. v22}, LL7/j;->a(LL7/i;FLandroid/graphics/RectF;LL7/f$a;Landroid/graphics/Path;)V
    ...
    iget-object v4, v0, LL7/f$b;->a:LL7/i;
    ...
    :goto_3
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/chip/a;->D()Z

    move-result v0

    if-eqz v0, :cond_a

    invoke-virtual {v6, v15, v10}, Lcom/google/android/material/chip/a;->q(Landroid/graphics/Rect;Landroid/graphics/RectF;)V
    ...
    iget-object v2, v6, Lcom/google/android/material/chip/a;->d0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_a
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/chip/a;->C()Z
    ...
    iget-object v0, v6, Lcom/google/android/material/chip/a;->b0:Ljava/lang/CharSequence;
    ...
    iget-object v2, v6, Lcom/google/android/material/chip/a;->b0:Ljava/lang/CharSequence;

    iget-object v3, v6, Lcom/google/android/material/chip/a;->E0:LF7/g;
    ...
    invoke-static/range {p0 .. p0}, LR1/b;->a(Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v4, v3, LF7/g;->a:Landroid/text/TextPaint;

    iget-object v5, v6, Lcom/google/android/material/chip/a;->A0:Landroid/graphics/Paint$FontMetrics;
    ...
    :cond_f
    iget-object v2, v3, LF7/g;->f:LI7/d;
    ...
    iget-object v5, v3, LF7/g;->b:LF7/g$a;

    iget-object v8, v6, Lcom/google/android/material/chip/a;->y0:Landroid/content/Context;

    invoke-virtual {v2, v8, v4, v5}, LI7/d;->e(Landroid/content/Context;Landroid/text/TextPaint;Lbf/a;)V

    :cond_10
    invoke-virtual {v4, v1}, Landroid/graphics/Paint;->setTextAlign(Landroid/graphics/Paint$Align;)V

    iget-object v1, v6, Lcom/google/android/material/chip/a;->b0:Ljava/lang/CharSequence;

    invoke-interface {v1}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;

    move-result-object v1

    iget-boolean v2, v3, LF7/g;->d:Z

    if-nez v2, :cond_11

    iget v1, v3, LF7/g;->c:F
    ...
    :goto_6
    iput v7, v3, LF7/g;->c:F

    iput-boolean v13, v3, LF7/g;->d:Z
    ...
    :goto_9
    iget-object v3, v6, Lcom/google/android/material/chip/a;->b0:Ljava/lang/CharSequence;
    ...
    iget-object v7, v6, Lcom/google/android/material/chip/a;->W0:Landroid/text/TextUtils$TruncateAt;
    ...
    :cond_17
    :goto_a
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/chip/a;->E()Z
    ...
    iget-object v7, v6, Lcom/google/android/material/chip/a;->i0:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v6, Lcom/google/android/material/chip/a;->j0:Landroid/graphics/drawable/RippleDrawable;

    iget-object v4, v6, Lcom/google/android/material/chip/a;->i0:Landroid/graphics/drawable/Drawable;
...
.method public final getIntrinsicWidth()I
    ...
    iget-object v2, p0, Lcom/google/android/material/chip/a;->E0:LF7/g;

    iget-boolean v3, v2, LF7/g;->d:Z

    if-nez v3, :cond_0

    iget v0, v2, LF7/g;->c:F
    ...
    :cond_1
    iget-object v4, v2, LF7/g;->a:Landroid/text/TextPaint;
    ...
    :goto_0
    iput v0, v2, LF7/g;->c:F

    iput-boolean v3, v2, LF7/g;->d:Z
...
.method public final getOutline(Landroid/graphics/Outline;)V
    ...
    invoke-super {p0, p1}, LL7/f;->getOutline(Landroid/graphics/Outline;)V
    ...
    iget v7, p0, Lcom/google/android/material/chip/a;->X:F
...
.method public final isStateful()Z
    ...
    invoke-static {v0}, Lcom/google/android/material/chip/a;->u(Landroid/content/res/ColorStateList;)Z
    ...
    iget-object v0, v0, LF7/g;->f:LI7/d;

    if-eqz v0, :cond_1

    iget-object v0, v0, LI7/d;->a:Landroid/content/res/ColorStateList;
...
.method public final onLayoutDirectionChanged(I)Z
    ...
    invoke-virtual {p0}, Lcom/google/android/material/chip/a;->D()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/material/chip/a;->d0:Landroid/graphics/drawable/Drawable;

    invoke-static {v1, p1}, LR1/b;->b(Landroid/graphics/drawable/Drawable;I)Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/material/chip/a;->C()Z
...
.method public final onStateChange([I)Z
    ...
    invoke-super {p0, p1}, LL7/f;->onStateChange([I)Z

    :cond_0
    iget-object v0, p0, Lcom/google/android/material/chip/a;->S0:[I

    invoke-virtual {p0, p1, v0}, Lcom/google/android/material/chip/a;->x([I[I)Z
...
.method public final p(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0}, LR1/b;->a(Landroid/graphics/drawable/Drawable;)I

    move-result v0

    invoke-static {p1, v0}, LR1/b;->b(Landroid/graphics/drawable/Drawable;I)Z
    ...
    iget-object p1, p0, Lcom/google/android/material/chip/a;->e0:Landroid/content/res/ColorStateList;
...
.method public final r()F
    ...
    :cond_2
    iget-object v2, p0, Lcom/google/android/material/chip/a;->d0:Landroid/graphics/drawable/Drawable;

    :goto_1
    iget v3, p0, Lcom/google/android/material/chip/a;->f0:F
...
.method public final x([I[I)Z
    ...
    iget-object v1, p0, Lcom/google/android/material/chip/a;->U:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    invoke-virtual {p0, v1}, LL7/f;->e(I)I
    ...
    :cond_1
    iget-object v3, p0, Lcom/google/android/material/chip/a;->V:Landroid/content/res/ColorStateList;
    ...
    :goto_1
    invoke-virtual {p0, v3}, LL7/f;->e(I)I
    ...
    :cond_3
    invoke-static {v3, v1}, LQ1/a;->f(II)I
    ...
    :goto_2
    iget-object v5, p0, LL7/f;->a:LL7/f$b;

    iget-object v5, v5, LL7/f$b;->c:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0}, LL7/f;->l(Landroid/content/res/ColorStateList;)V
    ...
    :cond_a
    iget-object v1, p0, Lcom/google/android/material/chip/a;->E0:LF7/g;

    iget-object v1, v1, LF7/g;->f:LI7/d;

    if-eqz v1, :cond_b

    iget-object v1, v1, LI7/d;->a:Landroid/content/res/ColorStateList;
    ...
    :cond_18
    iget-object p1, p0, Lcom/google/android/material/chip/a;->j0:Landroid/graphics/drawable/RippleDrawable;

    invoke-static {p1}, Lcom/google/android/material/chip/a;->v(Landroid/graphics/drawable/Drawable;)Z
...
.method public final z(Z)V
    ...
    iget-object p1, p0, Lcom/google/android/material/chip/a;->d0:Landroid/graphics/drawable/Drawable;

...
.method public final b(LN1/p;)V
    ...
    iget-object v3, v1, LN1/p;->b:Landroid/app/Notification$Builder;

    invoke-direct {v2, v3}, Landroid/app/Notification$BigPictureStyle;-><init>(Landroid/app/Notification$Builder;)V

    iget-object v3, v0, LN1/o;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, LN1/i;->e:Landroidx/core/graphics/drawable/IconCompat;

    const/4 v4, 0x0

    const/4 v5, 0x0

    iget-object v1, v1, LN1/p;->a:Landroid/content/Context;
    ...
    invoke-static {v3, v1}, Landroidx/core/graphics/drawable/IconCompat$a;->c(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    invoke-static {v2, v3}, LN1/i$b;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    iget-object v7, v0, LN1/i;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    :cond_6
    :goto_1
    iget-boolean v3, v0, LN1/i;->g:Z

    if-eqz v3, :cond_8

    iget-object v3, v0, LN1/i;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, LN1/i$a;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_8
    :goto_2
    iget-boolean v1, v0, LN1/o;->d:Z

    if-eqz v1, :cond_9

    iget-object v1, v0, LN1/o;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, LN1/i$b;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, LN1/i$b;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcm/b;->G:Ljava/lang/Object;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lcm/b;->a:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object v1, p0, Lcm/b;->E:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v2, p0, Lcm/b;->B:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iput v1, p0, Lcm/b;->A:I
    ...
    iput v3, p0, Lcm/b;->b:I

    iput-object v2, p0, Lcm/b;->D:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iput v1, p0, Lcm/b;->C:I

    add-int/lit8 p1, p1, -0x2

    int-to-long v1, p1

    iput-wide v1, p0, Lcm/b;->c:J
...
.method public final clear()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lcm/b;->poll()Ljava/lang/Object;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcm/b;->isEmpty()Z
...
.method public final isEmpty()Z
    ...
    iget-object v0, p0, Lcm/b;->a:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v0

    iget-object v2, p0, Lcm/b;->E:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public final offer(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lcm/b;->B:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lcm/b;->a:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget v5, p0, Lcm/b;->A:I

    and-int/2addr v4, v5

    iget-wide v6, p0, Lcm/b;->c:J
    ...
    iput-object v13, p0, Lcm/b;->B:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    add-long/2addr v2, v5

    sub-long/2addr v2, v7

    iput-wide v2, p0, Lcm/b;->c:J
    ...
    sget-object p1, Lcm/b;->G:Ljava/lang/Object;
...
.method public final poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcm/b;->D:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lcm/b;->E:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sget-object v7, Lcm/b;->G:Ljava/lang/Object;
    ...
    iput-object v6, p0, Lcm/b;->D:Ljava/util/concurrent/atomic/AtomicReferenceArray;

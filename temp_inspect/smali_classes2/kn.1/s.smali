...
# static fields
.field public static final D:Lkn/s;

.field public static final E:Lkn/s$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkn/s;->E:Lkn/s$a;

    new-instance v0, Lkn/s;

    invoke-direct {v0}, Lkn/s;-><init>()V

    sput-object v0, Lkn/s;->D:Lkn/s;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lkn/s;->c:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, Lkn/s;->B:B

    .line 8
    iput v0, p0, Lkn/s;->C:I

    .line 9
    sget-object v0, Lqn/c;->a:Lqn/m;

    iput-object v0, p0, Lkn/s;->a:Lqn/c;
...
.method public constructor <init>(Lqn/d;Lqn/e;)V
    ...
    iput-object v1, p0, Lkn/s;->c:Ljava/util/List;

    .line 14
    iput v0, p0, Lkn/s;->A:I
    ...
    .line 19
    :cond_2
    iget v5, p0, Lkn/s;->b:I

    or-int/2addr v5, v1

    iput v5, p0, Lkn/s;->b:I
    ...
    iput-object v5, p0, Lkn/s;->c:Ljava/util/List;

    move v4, v1

    .line 23
    :cond_4
    iget-object v5, p0, Lkn/s;->c:Ljava/util/List;

    sget-object v6, Lkn/p;->R:Lkn/p$a;
    ...
    .line 27
    iget-object p2, p0, Lkn/s;->c:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lkn/s;->c:Ljava/util/List;
    ...
    iput-object p2, p0, Lkn/s;->a:Lqn/c;
    ...
    .line 32
    iget-object p1, p0, Lkn/s;->c:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lkn/s;->c:Ljava/util/List;
    ...
    iput-object p1, p0, Lkn/s;->a:Lqn/c;
...
.method public static i(Lkn/s;)Lkn/s$b;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lkn/s$b;->m(Lkn/s;)V
...
.method public final a(Lkotlin/reflect/jvm/internal/impl/protobuf/CodedOutputStream;)V
    ...
    invoke-virtual {p0}, Lkn/s;->b()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lkn/s;->c:Ljava/util/List;
...
.method public final b()I
    ...
    :goto_0
    iget-object v2, p0, Lkn/s;->c:Ljava/util/List;
...
.method public final c()Lqn/n$a;
    ...
    invoke-static {p0}, Lkn/s;->i(Lkn/s;)Lkn/s$b;
...
.method public final f()Z
    ...
    :goto_0
    iget-object v3, p0, Lkn/s;->c:Ljava/util/List;

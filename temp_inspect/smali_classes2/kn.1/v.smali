...
# static fields
.field public static final B:Lkn/v;

.field public static final C:Lkn/v$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lkn/v$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lkn/v;->C:Lkn/v$a;

    new-instance v0, Lkn/v;

    invoke-direct {v0}, Lkn/v;-><init>()V

    sput-object v0, Lkn/v;->B:Lkn/v;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, Lkn/v;->c:B

    .line 8
    iput v0, p0, Lkn/v;->A:I

    .line 9
    sget-object v0, Lqn/c;->a:Lqn/m;

    iput-object v0, p0, Lkn/v;->a:Lqn/c;
...
.method public constructor <init>(Lqn/d;Lqn/e;)V
    ...
    iput-object v0, p0, Lkn/v;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lkn/v;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lkn/v;->b:Ljava/util/List;

    sget-object v6, Lkn/u;->I:Lkn/u$a;
    ...
    .line 23
    iget-object p2, p0, Lkn/v;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lkn/v;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lkn/v;->a:Lqn/c;
    ...
    .line 28
    iget-object p1, p0, Lkn/v;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lkn/v;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lkn/v;->a:Lqn/c;
...
.method public final a(Lkotlin/reflect/jvm/internal/impl/protobuf/CodedOutputStream;)V
    ...
    invoke-virtual {p0}, Lkn/v;->b()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lkn/v;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Lkn/v;->a:Lqn/c;
...
.method public final b()I
    ...
    :goto_0
    iget-object v2, p0, Lkn/v;->b:Ljava/util/List;
...
.method public final c()Lqn/n$a;
    ...
    invoke-virtual {v0, p0}, Lkn/v$b;->m(Lkn/v;)V

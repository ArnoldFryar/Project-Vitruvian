...
# static fields
.field public static final a:LNi/i;
...
.method public final a(Lu2/k;Lj5/a;Lk5/b;Lqm/d;)Ljava/lang/Object;
    ...
    instance-of v0, p4, LNi/i$a;

    if-eqz v0, :cond_0

    move-object v0, p4

    check-cast v0, LNi/i$a;

    iget v1, v0, LNi/i$a;->c:I
    ...
    iput v1, v0, LNi/i$a;->c:I

    goto :goto_0

    :cond_0
    new-instance v0, LNi/i$a;

    invoke-direct {v0, p0, p4}, LNi/i$a;-><init>(LNi/i;Lqm/d;)V

    :goto_0
    iget-object p4, v0, LNi/i$a;->a:Ljava/lang/Object;

    sget-object v1, Lrm/a;->a:Lrm/a;

    iget v2, v0, LNi/i$a;->c:I
    ...
    const-string p1, "SignInProviderGoogle"

    const-string p2, "Sign in successful"

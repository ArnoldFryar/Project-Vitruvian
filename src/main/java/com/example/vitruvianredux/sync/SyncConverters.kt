...
fun WorkoutSessionRecord.toSync(): SyncSession = SyncSession(
    ...
    durationSec   = durationSec,
    strengthTestProtocolType = strengthTestProtocolType,
    strengthTestedExerciseId = strengthTestedExerciseId,
    strengthTestedExerciseName = strengthTestedExerciseName,
    certifiedOneRepMaxLb = certifiedOneRepMaxLb,
    failedOneRepMaxLb = failedOneRepMaxLb,
    updatedAt     = updatedAt,
    deletedAt     = deletedAt,
    deviceId      = deviceId,
)

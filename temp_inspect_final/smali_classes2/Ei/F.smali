...
.method static constructor <clinit>()V
    ...
    sput-object v0, LEi/F;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public constructor <init>(Lck/a;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lkm/l;)V
    ...
    iput-object p2, p0, LEi/F;->a:Ljava/lang/String;

    iput-object p3, p0, LEi/F;->b:Ljava/util/List;

    iput-object p4, p0, LEi/F;->c:Ljava/util/List;

    iput-object p5, p0, LEi/F;->A:Ljava/util/List;

    iput-object p1, p0, LEi/F;->B:Lck/a;

    iput-object p6, p0, LEi/F;->C:Ljava/util/List;

    iput-object p7, p0, LEi/F;->D:Ljava/util/List;

    iput-object p8, p0, LEi/F;->E:Ljava/util/List;

    iput-object p9, p0, LEi/F;->F:Lkm/l;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, LEi/F;->a:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object v0, p0, LEi/F;->b:Ljava/util/List;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    iget-object v0, p0, LEi/F;->c:Ljava/util/List;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeStringList(Ljava/util/List;)V

    iget-object v0, p0, LEi/F;->A:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, LEi/F;->B:Lck/a;
    ...
    :cond_1
    iget-object v0, p0, LEi/F;->D:Ljava/util/List;
    ...
    :cond_2
    iget-object v0, p0, LEi/F;->E:Ljava/util/List;
    ...
    :cond_3
    iget-object p2, p0, LEi/F;->F:Lkm/l;

...
# static fields
.field public static final B:Lkn/n;

.field public static final C:Lkn/n$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkn/n;->C:Lkn/n$a;

    new-instance v0, Lkn/n;

    invoke-direct {v0}, Lkn/n;-><init>()V

    sput-object v0, Lkn/n;->B:Lkn/n;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lkn/n;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, Lkn/n;->c:B

    .line 8
    iput v0, p0, Lkn/n;->A:I

    .line 9
    sget-object v0, Lqn/c;->a:Lqn/m;

    iput-object v0, p0, Lkn/n;->a:Lqn/c;
...
.method public constructor <init>(Lqn/d;Lqn/e;)V
    ...
    iput-object v0, p0, Lkn/n;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lkn/n;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lkn/n;->b:Ljava/util/List;

    sget-object v6, Lkn/n$c;->F:Lkn/n$c$a;
    ...
    iput-object p2, p0, Lkn/n;->a:Lqn/c;
    ...
    .line 28
    iget-object p1, p0, Lkn/n;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lkn/n;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lkn/n;->a:Lqn/c;
...
.method public final a(Lkotlin/reflect/jvm/internal/impl/protobuf/CodedOutputStream;)V
    ...
    invoke-virtual {p0}, Lkn/n;->b()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lkn/n;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Lkn/n;->a:Lqn/c;
...
.method public final c()Lqn/n$a;
    ...
    new-instance v0, Lkn/n$b;

    invoke-direct {v0}, Lkn/n$b;-><init>()V

    invoke-virtual {v0, p0}, Lkn/n$b;->m(Lkn/n;)V
...
.method public final f()Z
    ...
    :goto_0
    iget-object v3, p0, Lkn/n;->b:Ljava/util/List;
    ...
    check-cast v3, Lkn/n$c;

    invoke-virtual {v3}, Lkn/n$c;->f()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lkn/n;->c:B

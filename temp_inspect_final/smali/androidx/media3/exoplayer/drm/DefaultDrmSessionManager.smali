...
.field public final i:Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$e;

.field public final j:Landroidx/media3/exoplayer/upstream/b;

.field public final k:Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$f;
...
.field public x:LR2/m0;

.field public volatile y:Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$c;


# direct methods
.method public constructor <init>(Ljava/util/UUID;Landroidx/media3/exoplayer/drm/g$c;Landroidx/media3/exoplayer/drm/i;Ljava/util/HashMap;Z[IZLandroidx/media3/exoplayer/upstream/a;J)V
    .locals 2
...
.method public static h(Landroidx/media3/exoplayer/drm/DefaultDrmSession;)Z
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->f()Landroidx/media3/exoplayer/drm/DrmSession$DrmSessionException;
...
.method public static k(Landroidx/media3/common/g;Ljava/util/UUID;Z)Ljava/util/ArrayList;
    ...
    sget-object v3, LH2/g;->b:Ljava/util/UUID;
    ...
    :cond_0
    iget-object v3, v2, Landroidx/media3/common/g$b;->B:[B
...
.method public final a()V
    ...
    invoke-virtual {v2, v3}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->d(Landroidx/media3/exoplayer/drm/b$a;)V
    ...
    invoke-static {v0}, LW7/v;->z(Ljava/util/Set;)LW7/v;
    ...
    invoke-virtual {v1}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$d;->a()V
...
.method public final b(Landroid/os/Looper;LR2/m0;)V
    ...
    iput-object p2, p0, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->x:LR2/m0;
...
.method public final c(Landroidx/media3/exoplayer/drm/b$a;Landroidx/media3/common/i;)Landroidx/media3/exoplayer/drm/DrmSession;
    ...
    invoke-virtual {p0, v0, p1, p2, v2}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->f(Landroid/os/Looper;Landroidx/media3/exoplayer/drm/b$a;Landroidx/media3/common/i;Z)Landroidx/media3/exoplayer/drm/DrmSession;
...
.method public final d(Landroidx/media3/common/i;)I
    ...
    invoke-interface {v1}, Landroidx/media3/exoplayer/drm/g;->m()I
    ...
    iget v4, v2, Landroidx/media3/common/g;->A:I

    if-ne v4, v3, :cond_7

    iget-object v4, v2, Landroidx/media3/common/g;->a:[Landroidx/media3/common/g$b;
    ...
    :cond_4
    iget-object p1, v2, Landroidx/media3/common/g;->c:Ljava/lang/String;
...
.method public final e(Landroidx/media3/exoplayer/drm/b$a;Landroidx/media3/common/i;)Landroidx/media3/exoplayer/drm/c$b;
    .locals 3
    ...
    invoke-direct {v0, p0, p1}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$d;-><init>(Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;Landroidx/media3/exoplayer/drm/b$a;)V
    ...
    invoke-direct {v2, v0, v1, p2}, LT2/a;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final f(Landroid/os/Looper;Landroidx/media3/exoplayer/drm/b$a;Landroidx/media3/common/i;Z)Landroidx/media3/exoplayer/drm/DrmSession;
    .locals 4
    ...
    :cond_0
    iget-object p1, p3, Landroidx/media3/common/i;->L:Landroidx/media3/common/g;
    ...
    iget-object p1, p3, Landroidx/media3/common/i;->I:Ljava/lang/String;

    invoke-static {p1}, LH2/s;->h(Ljava/lang/String;)I

    move-result p1

    iget-object p2, p0, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->q:Landroidx/media3/exoplayer/drm/g;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p2}, Landroidx/media3/exoplayer/drm/g;->m()I
    ...
    invoke-virtual {p0, p1, p2, v1, p4}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->j(Ljava/util/List;ZLandroidx/media3/exoplayer/drm/b$a;Z)Landroidx/media3/exoplayer/drm/DefaultDrmSession;
    ...
    :cond_3
    invoke-virtual {p1, v1}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->a(Landroidx/media3/exoplayer/drm/b$a;)V
    ...
    invoke-static {p3, p4, p1}, LK2/m;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    if-eqz p2, :cond_7

    invoke-virtual {p2, p1}, Landroidx/media3/exoplayer/drm/b$a;->e(Ljava/lang/Exception;)V
    ...
    invoke-static {v3, p1}, LK2/D;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, v0, p2, p4}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->j(Ljava/util/List;ZLandroidx/media3/exoplayer/drm/b$a;Z)Landroidx/media3/exoplayer/drm/DefaultDrmSession;
    ...
    :cond_e
    invoke-virtual {v1, p2}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->a(Landroidx/media3/exoplayer/drm/b$a;)V
...
.method public final g()V
    ...
    invoke-interface {v0, v1}, Landroidx/media3/exoplayer/drm/g$c;->a(Ljava/util/UUID;)Landroidx/media3/exoplayer/drm/g;
    ...
    invoke-interface {v0, v1}, Landroidx/media3/exoplayer/drm/g;->i(Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$b;)V
    ...
    invoke-virtual {v1, v2}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->a(Landroidx/media3/exoplayer/drm/b$a;)V
...
.method public final i(Ljava/util/List;ZLandroidx/media3/exoplayer/drm/b$a;)Landroidx/media3/exoplayer/drm/DefaultDrmSession;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v15, v0, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->x:LR2/m0;
    ...
    iget-object v12, v0, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->j:Landroidx/media3/exoplayer/upstream/b;
    ...
    invoke-direct/range {v2 .. v16}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;-><init>(Ljava/util/UUID;Landroidx/media3/exoplayer/drm/g;Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$e;Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager$f;Ljava/util/List;IZZ[BLjava/util/HashMap;Landroidx/media3/exoplayer/drm/j;Landroid/os/Looper;Landroidx/media3/exoplayer/upstream/b;LR2/m0;)V
...
.method public final j(Ljava/util/List;ZLandroidx/media3/exoplayer/drm/b$a;Z)Landroidx/media3/exoplayer/drm/DefaultDrmSession;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/exoplayer/drm/DefaultDrmSessionManager;->i(Ljava/util/List;ZLandroidx/media3/exoplayer/drm/b$a;)Landroidx/media3/exoplayer/drm/DefaultDrmSession;
    ...
    invoke-static {v1}, LW7/v;->z(Ljava/util/Set;)LW7/v;

    move-result-object v1

    invoke-virtual {v1}, LW7/r;->v()LW7/U;
    ...
    invoke-interface {v8, v6}, Landroidx/media3/exoplayer/drm/DrmSession;->d(Landroidx/media3/exoplayer/drm/b$a;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v0, p3}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->d(Landroidx/media3/exoplayer/drm/b$a;)V

    cmp-long v1, v4, v2

    if-eqz v1, :cond_1

    invoke-virtual {v0, v6}, Landroidx/media3/exoplayer/drm/DefaultDrmSession;->d(Landroidx/media3/exoplayer/drm/b$a;)V
    ...
    invoke-static {p4}, LW7/v;->z(Ljava/util/Set;)LW7/v;

    move-result-object p4

    invoke-virtual {p4}, LW7/r;->v()LW7/U;
    ...
    invoke-static {v7}, LW7/v;->z(Ljava/util/Set;)LW7/v;
    ...
    invoke-interface {v1, v6}, Landroidx/media3/exoplayer/drm/DrmSession;->d(Landroidx/media3/exoplayer/drm/b$a;)V
...
.method public final l()V
    ...
    invoke-interface {v0}, Landroidx/media3/exoplayer/drm/g;->a()V
...
.method public final m(Z)V
    ...
    invoke-static {v0, v1, p1}, LK2/m;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, p1, v1}, LK2/m;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

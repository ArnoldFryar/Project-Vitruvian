...
# static fields
.field public static final n:LW7/K;

.field public static final o:LW7/K;

.field public static final p:LW7/K;

.field public static final q:LW7/K;

.field public static final r:LW7/K;

.field public static final s:LW7/K;

.field public static t:Le3/h;
...
.field public final b:Le3/d$a$a;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v1, v2, v3, v4}, LW7/t;->L(Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;)LW7/K;

    move-result-object v0

    sput-object v0, Le3/h;->n:LW7/K;
    ...
    invoke-static {v0, v1, v2, v5, v6}, LW7/t;->L(Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;)LW7/K;

    move-result-object v0

    sput-object v0, Le3/h;->o:LW7/K;
    ...
    invoke-static {v0, v2, v5, v4, v6}, LW7/t;->L(Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;)LW7/K;

    move-result-object v4

    sput-object v4, Le3/h;->p:LW7/K;
    ...
    invoke-static {v4, v3, v6, v7, v8}, LW7/t;->L(Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;)LW7/K;

    move-result-object v4

    sput-object v4, Le3/h;->q:LW7/K;
    ...
    invoke-static {v4, v6, v7, v3, v1}, LW7/t;->L(Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;)LW7/K;

    move-result-object v1

    sput-object v1, Le3/h;->r:LW7/K;
    ...
    invoke-static {v1, v0, v3, v2, v5}, LW7/t;->L(Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;)LW7/K;

    move-result-object v0

    sput-object v0, Le3/h;->s:LW7/K;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/util/HashMap;ILK2/x;Z)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-static {p2}, LW7/u;->c(Ljava/util/Map;)LW7/u;

    move-result-object p2

    iput-object p2, p0, Le3/h;->a:LW7/u;

    new-instance p2, Le3/d$a$a;

    invoke-direct {p2}, Le3/d$a$a;-><init>()V

    iput-object p2, p0, Le3/h;->b:Le3/d$a$a;

    new-instance p2, Le3/j;

    invoke-direct {p2, p3}, Le3/j;-><init>(I)V

    iput-object p2, p0, Le3/h;->e:Le3/j;

    iput-object p4, p0, Le3/h;->c:LK2/c;

    iput-boolean p5, p0, Le3/h;->d:Z

    if-eqz p1, :cond_2

    invoke-static {p1}, LK2/t;->b(Landroid/content/Context;)LK2/t;

    move-result-object p1

    invoke-virtual {p1}, LK2/t;->c()I

    move-result p2

    iput p2, p0, Le3/h;->m:I

    invoke-virtual {p0, p2}, Le3/h;->i(I)J
    ...
    invoke-direct {p2, p0}, Le3/g;-><init>(Le3/h;)V

    iget-object p3, p1, LK2/t;->b:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object p3, p1, LK2/t;->a:Landroid/os/Handler;

    new-instance p4, Lw/i;

    const/4 p5, 0x2

    invoke-direct {p4, p1, p5, p2}, Lw/i;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Le3/h;->i(I)J

    move-result-wide p1

    iput-wide p1, p0, Le3/h;->k:J
...
.method public final a(LR2/a;)V
    ...
    iget-object v0, p0, Le3/h;->b:Le3/d$a$a;

    iget-object v0, v0, Le3/d$a$a;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    check-cast v2, Le3/d$a$a$a;

    iget-object v3, v2, Le3/d$a$a$a;->b:Le3/d$a;

    if-ne v3, p1, :cond_0

    const/4 v3, 0x1

    iput-boolean v3, v2, Le3/d$a$a$a;->c:Z
...
.method public final b(Landroid/os/Handler;LR2/a;)V
    .locals 4
    ...
    :cond_1
    new-instance v1, Le3/d$a$a$a;

    invoke-direct {v1, p1, p2}, Le3/d$a$a$a;-><init>(Landroid/os/Handler;LR2/a;)V
...
.method public final declared-synchronized c(LN2/e;ZI)V
    .locals 2
    ...
    :cond_0
    iget-wide p1, p0, Le3/h;->h:J

    int-to-long v0, p3

    add-long/2addr p1, v0

    iput-wide p1, p0, Le3/h;->h:J
    :try_end_0
...
.method public final d()Le3/h;
    .locals 0

    return-object p0
.end method

.method public final declared-synchronized e(LN2/e;Z)V
    .locals 10
    ...
    iget-object p1, p0, Le3/h;->c:LK2/c;

    invoke-interface {p1}, LK2/c;->e()J

    move-result-wide v0

    iget-wide v2, p0, Le3/h;->g:J

    sub-long v2, v0, v2

    long-to-int v5, v2

    iget-wide v2, p0, Le3/h;->i:J

    int-to-long v6, v5

    add-long/2addr v2, v6

    iput-wide v2, p0, Le3/h;->i:J

    iget-wide v2, p0, Le3/h;->j:J

    iget-wide v6, p0, Le3/h;->h:J

    add-long/2addr v2, v6

    iput-wide v2, p0, Le3/h;->j:J
    ...
    iget-object v2, p0, Le3/h;->e:Le3/j;
    ...
    invoke-virtual {v2, v3, p1}, Le3/j;->a(IF)V
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Le3/h;->e:Le3/j;

    invoke-virtual {p1}, Le3/j;->b()F

    move-result p1

    float-to-long v2, p1

    iput-wide v2, p0, Le3/h;->k:J

    :cond_3
    iget-wide v6, p0, Le3/h;->h:J

    iget-wide v8, p0, Le3/h;->k:J

    move-object v4, p0

    invoke-virtual/range {v4 .. v9}, Le3/h;->j(IJJ)V

    iput-wide v0, p0, Le3/h;->g:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Le3/h;->h:J
...
.method public final declared-synchronized f(LN2/e;Z)V
    .locals 0
...
.method public final i(I)J
    ...
    iget-object v0, p0, Le3/h;->a:LW7/u;
...
.method public final j(IJJ)V
    ...
    check-cast v1, Le3/d$a$a$a;

    iget-boolean v2, v1, Le3/d$a$a$a;->c:Z
    ...
    invoke-direct/range {v2 .. v8}, Le3/c;-><init>(Le3/d$a$a$a;IJJ)V

    iget-object v1, v1, Le3/d$a$a$a;->a:Landroid/os/Handler;

...
.method public a(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, LJ6/c;->b(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p2}, LL6/c;->a(Landroid/content/Context;)LL6/b;
    ...
    invoke-virtual {p3, v0, p2}, LL6/b;->a(ILjava/lang/String;)Landroid/content/pm/PackageInfo;
...
.method public b(ILandroid/content/Context;)I
    ...
    sget-object v0, LA6/h;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v0, LE6/T;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, LE6/T;->b:Z
    ...
    sget-object v0, LJ6/c;->c:Ljava/lang/Boolean;
    ...
    sput-object v0, LJ6/c;->c:Ljava/lang/Boolean;
    ...
    invoke-static {v7, v1}, LA6/i;->d(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v6, v1}, LA6/i;->d(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p2}, LA6/h;->b(Landroid/content/Context;)Z
